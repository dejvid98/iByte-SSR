...
const RamPage = () => {
  ...
  useEffect(() => {
    setIsLoading(true)
    setProductsList([])
    let query = process.env.SERVER + 'ram?'
  ...
  }, [brand, memory, speed, min, max, rating, sort])
          ...
          <div className='product-page-body'>
            <div className='product-filters'>
              ...
              <div className='brands'>
                ...
                <Radio.Group onChange={(e) => setSpeed(e.target.value)} value={speed}>
                  <Radio style={radioStyle} value={1666}>
                    1666 Mhz
                  </Radio>

                  <Radio style={radioStyle} value={2166}>
                    2166 Mhz
                  </Radio>

                  <Radio style={radioStyle} value={2666}>
                    2666 Mhz
                  </Radio>

                  <Radio style={radioStyle} value={3166}>
                    3166 Mhz
                  </Radio>
                </Radio.Group>
              </div>
