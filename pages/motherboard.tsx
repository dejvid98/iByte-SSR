...
const MotherboardPage = () => {
  ...
  useEffect(() => {
    setIsLoading(true)
    setProductsList([])
    let query = process.env.SERVER + 'motherboard?'
  ...
  }, [brand, format, min, max, rating, sort])
            ...
            <div className='product-filters'>
              ...
              <div className='brands'>
                ...
                <Radio.Group onChange={(e) => setFormat(e.target.value)} value={format}>
                  <Radio style={radioStyle} value={'ATX'}>
                    ATX
                  </Radio>

                  <Radio style={radioStyle} value={'E-ATX'}>
                    E-ATX
                  </Radio>

                  <Radio style={radioStyle} value={'MICRO-ATX'}>
                    MICRO-ATX
                  </Radio>
                </Radio.Group>
              </div>
